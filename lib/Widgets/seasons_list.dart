...
/// I render a horizontal list of episodes for the selected season.
class SeasonsList extends StatefulWidget {
  const SeasonsList(this.seasonNumber, this.movieId, {super.key});
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: const Color(0xFFA3A3B0).withValues(alpha: 0.5),
                        width: 0.75,
                      ),
                    ),
