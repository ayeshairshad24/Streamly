/// Student Note:
/// `TvShow` represents a single TV show item from TMDB list endpoints (e.g., popular/top-rated).
/// I use this in list views and cards.
///
/// Important fields: `id`, `name`, `posterPath`, `backdropPath`, `firstAirDate`.
/// `genreIds` is a list of numeric IDs that map to genre names.
class TvShow {
  TvShow({
    String? backdropPath,
    String? firstAirDate,
