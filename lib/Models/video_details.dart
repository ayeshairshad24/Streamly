/// Student Note:
/// `VideoDetails` contains a list of videos (trailers, clips) for a movie or TV show.
/// I use this to find the YouTube key for a trailer.
class VideoDetails {
  VideoDetails({
    num? id,
...
class VideoResults {
  /// Student Note:
  /// Represents a single video. `key` is the YouTube video ID.
  /// `site` should be "YouTube" and `type` "Trailer" for best results.
  VideoResults({
    String? iso6391,
    String? iso31661,
    String? name,
