/// Student Note:
/// `PopularMovies` maps the response from TMDB movie list endpoints.
/// `Results` represents each individual movie summary.
/// Important fields in `Results`: `id`, `title`, `poster_path`, `backdrop_path`, `vote_average` — these drive UI thumbnails and ratings.
class PopularMovies {
  PopularMovies({
    num? page,
